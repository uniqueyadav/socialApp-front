...
//           {/* User profile picture from populate or fallback */}
//           <img 
//             src={post.user?.profilePic || post.userProfilePic || 'https://via.placeholder.com/40'} 
//             alt="u" 
...
//       {/* Post Media (Image/Video handle logic as per your Schema) */}
//       {(post.image || post.video || post.fileUrl) && (
//         <div className="post-media-wrapper bg-light" style={{minHeight: '200px'}}>
//           {/* Video Check */}
//           {(post.video || post.postType === 'video') ? (
//             <div className='player-wrapper'>
//               <ReactPlayer 
//                 url={post.video || post.fileUrl} 
//                 controls 
//                 width="100%" 
//                 height="auto" 
//               />
...
//   // --- Backend Base URL (Photo/Video show karne ke liye) ---
...
//     if (!path) return null;
//     // Agar path pehle se 'http' se shuru ho raha hai (link post), toh wahi return karo
//     // Warna Backend address (PF) ke saath join karo
...
//             <div className='player-wrapper'>
//               <ReactPlayer 
//                 url={getMediaUrl(post.video || post.fileUrl)} 
//                 controls 
//                 width="100%" 
//                 height="auto" 
//               />
...
const PostCard = ({ post, refresh }) => {
  ...
  return (
    <div className="app-card mb-4 shadow-sm border-0 overflow-hidden animate-fade-in bg-white" style={{borderRadius: '12px'}}>
      ...
      {(post.image || post.video || post.fileUrl) && (
        <div className="post-media-wrapper bg-light" style={{minHeight: '200px'}}>
          {/* Video Check - Modified to use native video tag for better local file support */}
